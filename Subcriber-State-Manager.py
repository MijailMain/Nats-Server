...
print ('*********************************************************************')
print('Runing... Nats Subscriber [VSBLTY-DATA-STATE]')
print('   - Host: ', Hostname)
...
#///////////////////////////////////////////////////////////////////////
ChannelNatsSubscriber = 'VSBLTY-DATA-STATE-ab5b9637-4a70-4098-a04f-ff9eea18574f'

#///////////////////////////////////////////////////////////////////////
# Client name or cliendID (This must be Unique within the Nats Server)
#///////////////////////////////////////////////////////////////////////
SubscriberId = "Client-Python-STATE"
...
async def run(loop):
    ...
    async def cb(msg):
        ...
        print ('- [Subscriber] - [State-Manager] - Msg:' + str(msg.seq) + ' - ' + str(timestampStr))
        ...
        # Defining File Name
        file_name =  MessageId + " - [ State - Manager ] - Msg - [" + str(msg.seq) + "] - Kiosk.json"
