...
print ('*********************************************************************')
print('Runing... Nats Subscriber [VSBLTY-DATA-FACE]')
print('   - Host: ', Hostname)
...
#///////////////////////////////////////////////////////////////////////
ChannelNatsSubscriber = 'VSBLTY-DATA-FACE-2a8b5f06-46ac-4260-a39e-e87621119daa'

#///////////////////////////////////////////////////////////////////////
# Client name or cliendID (This must be Unique within the Nats Server)
#///////////////////////////////////////////////////////////////////////
SubscriberId = "Client-Python-FACE"
...
async def run(loop):
    ...
    async def cb(msg):
        ...
        print ('- [Subscriber] - [Face-Detection] - Msg:' + str(msg.seq) + ' - ' + str(timestampStr))
        ...
        # Defining File Name
        file_name =  MessageId + " - [ Face - Detection ] - Msg - [" + str(msg.seq) + "] - Kiosk.json"
